...
const generateHTML = (pageName) => {
  ...
  <div class="oops-message">
      <div class="test">GET BACK TO WORK</div>
      <div>
          <span class="test">STUDYING > ${pageName}</span>
      </div>
      <a class="button" href="mailto:amar.kumar2020@vitbhopal.ac.in">GET BACK TO STUDY</a>
  </div>
</div>
